...
public class AccountTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("myAccount: %s %f %n%n", myAccount.getName(), 
        ...
        System.out.printf("account1: %s %f %n%n", account1.getName(), 
                account1.getBalance());
        System.out.printf("account2: %s %f %n%n", account2.getName(), 
                account2.getBalance());
        ...
        System.out.printf("account3: %s %f %n%n", account3.getName(), 
                account3.getBalance());
